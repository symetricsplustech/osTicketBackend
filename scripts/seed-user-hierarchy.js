...
const AGENT_PERMISSIONS = {
  admin: [
    // Legacy admin permissions (kept for backward compat)
    "admin.manage",
    "access.manage",
    "roles.manage",
    "users.manage",
    ...
    // Granular ITSM permissions (Modules 1-12) - Full access
    "itsm.core.*",
    "itsm.incident.*",
    "itsm.problem.*",
    "itsm.change.*",
    "itsm.request_catalog.*",
    "itsm.knowledge.*",
    "itsm.sla.*",
    "itsm.assignment.*",
    "itsm.approval.*",
  ...
  l1: [
    ...
    "tickets.close",
    "tickets.tasks",
    // Granular ITSM permissions - Incident-focused L1 agent
    "itsm.incident.incident.read",
    "itsm.incident.incident.create",
    "itsm.incident.incident.update",
    "itsm.incident.incident.assign",
    "itsm.incident.incident.close",
    "itsm.incident.incident.reopen",
  ...
  l2: [
    ...
    "tickets.tasks",
    "tickets.transfer",
    // Granular ITSM permissions - L2 technician
    "itsm.incident.incident.read",
    "itsm.incident.incident.create",
    "itsm.incident.incident.update",
    "itsm.incident.incident.assign",
    "itsm.incident.incident.reassign",
    "itsm.incident.incident.close",
    "itsm.incident.incident.reopen",
    "itsm.incident.add_public_comment",
    "itsm.incident.add_work_note",
    ...
    "itsm.incident.ui.incident_record.access",
    "itsm.incident.ui.incident_dashboards.access",
    "itsm.incident.ui.diagnosis.access",
    "itsm.incident.ui.triage_panel.access",
    "itsm.incident.ui.playbooks.access",
    ...
    "itsm.approval.ui.my_approvals.access",
    "itsm.approval.ui.approval_detail.access",
  ],
  l3: [
    // Legacy L3 permissions
    "tickets.view",
    "tickets.assign",
    "tickets.transfer",
    "tickets.reply",
    ...
    "escalations.manage",
    "orgs.manage",
    // Granular ITSM permissions - Senior engineer / Team lead
    "itsm.incident.incident.read",
    "itsm.incident.incident.create",
    "itsm.incident.incident.update",
    "itsm.incident.incident.assign",
    ...
    "itsm.incident.incident.close",
    "itsm.incident.incident.reopen",
    "itsm.incident.incident.bulk_update",
    "itsm.incident.add_public_comment",
    "itsm.incident.add_work_note",
    "itsm.incident.claim",
    "itsm.incident.link_knowledge",
    ...
    "itsm.incident.ui.triage_panel.access",
    "itsm.incident.ui.playbooks.access",
    "itsm.incident.ui.priority_matrix.access",
    "itsm.incident.ui.escalations.access",
    "itsm.problem.problem.read",
    "itsm.problem.problem.create",
    "itsm.problem.problem.update",
    "itsm.problem.assign",
    ...
    "itsm.approval.approval_approve",
    "itsm.approval.approval_reject",
    "itsm.approval.approval_override",
    "itsm.approval.ui.my_approvals.access",
    "itsm.approval.ui.approval_detail.access",
    "itsm.approval.ui.approval_configuration.access",
    "itsm.major_incident.major_incident.read",
    "itsm.major_incident.major_incident.create",
    "itsm.major_incident.major_incident.update",
    "itsm.major_incident.promote",
    "itsm.major_incident.assign_manager",
    "itsm.major_incident.assign_commander",
    "itsm.major_incident.manage_response_team",
    "itsm.major_incident.manage_stakeholders",
    "itsm.major_incident.manage_bridge",
    "itsm.major_incident.communication_send",
    "itsm.major_incident.timeline_manage",
    "itsm.major_incident.pir_create",
    "itsm.major_incident.pir_update",
    "itsm.major_incident.ui.mi_workbench.access",
    "itsm.major_incident.ui.mi_dashboard.access",
    "itsm.major_incident.ui.candidate_queue.access",
    "itsm.major_incident.ui.communicate.access",
    "itsm.major_incident.ui.collaborate.access",
    "itsm.major_incident.ui.timeline.access",
