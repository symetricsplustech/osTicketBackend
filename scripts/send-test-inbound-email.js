...
const body =
  process.argv[3] ||
  "This is a test email to verify email-to-ticket creation. Please create a ticket from this message.";
...
const appendViaImap = async () => {
  ...
  await client.logout();
  console.log(
    `Appended to ${process.env.EMAIL_USER}/${mailbox} from ${sender}`,
  );
};
