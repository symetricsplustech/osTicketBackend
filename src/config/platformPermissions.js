const P = Object.freeze({
  ...
  MODULE_FEATURE_FLAGS: "saas.module.manage_feature_flags",
  ...
  OPERATIONS_READ: "saas.operations.health.read",
  OPERATIONS_MANAGE: "saas.operations.manage",
...
const without = (...keys) =>
  Object.values(P).filter((permission) => !keys.includes(permission));
const ROLE_PERMISSIONS = Object.freeze({
  ...
  platform_operations_administrator: [
    ...
    P.TENANT_ARCHIVE,
    P.TENANT_RESTORE,
    P.TENANT_MANAGE_MODULES,
    P.TENANT_MANAGE_LIMITS,
    P.TENANT_VIEW_USAGE,
    P.MODULE_READ,
    P.MODULE_CONFIGURE,
    P.MODULE_FEATURE_FLAGS,
    P.OPERATIONS_READ,
    P.OPERATIONS_MANAGE,
    P.AUDIT_READ,
  ...
  platform_security_administrator: [
    ...
    P.TENANT_READ,
    P.SECURITY_READ,
    P.SECURITY_CONFIGURE,
    P.SESSION_REVOKE,
    P.SECURITY_BREAK_GLASS,
    P.AUDIT_READ,
    P.AUDIT_EXPORT,
    P.OPERATIONS_READ,
  ],
