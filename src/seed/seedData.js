const emailTemplates = [
  {
    ...
    description:
      "Sent to the customer when a new ticket is created to confirm it was received.",
...
%{company.name}`,
  ...
  },
  {
    ...
    description:
      "Sent to the assigned department staff when a new ticket arrives.",
...
Thank you.`,
  ...
  },
  {
    ...
    description:
      "Sent to the assigned agent when the customer posts a new reply on a ticket.",
...
%{urls.agent}`,
  ...
  },
  {
    ...
    description:
      "Sent to the customer when a staff member responds to their ticket.",
...
%{urls.agent}`,
  ...
  },
  {
    ...
    description:
      "Sent to the customer when an agent marks their ticket resolved, asking them to confirm.",
...
%{company.name}`,
  ...
  },
  {
    ...
    description:
      "Sent to the assigned agent when the first-response target passes with no agent reply.",
    subject:
      "RESPONSE SLA BREACHED: %{ticketNumber} is awaiting first response",
...
%{company.name}`,
  ...
  },
  {
    ...
    description:
      "Sent to a customer when their account is created on the portal.",
...
%{company.name}`,
  ...
  },
  {
    ...
    description:
      "Sent to an employee when their portal account is created by an admin.",
...
%{company.name}`,
  ...
  },
  {
    ...
    description:
      "Sent to the admin when their company is registered on the platform.",
...
%{company.name}`,
  ...
  },
  {
    ...
    description:
      "Sent to the registered email when a company is created on the platform.",
...
%{company.name}`,
  ...
  // ---- Enterprise: communication automation ----
  {
    ...
    name: "SLA Warning",
    description:
      "Sent to the assigned agent when a ticket is at risk of breaching its SLA.",
...
%{company.name}`,
  ...
  },
  {
    ...
    description:
      "Sent to the customer when a ticket is waiting on their input.",
...
%{company.name}`,
  ...
  },
  {
    ...
    name: "CSAT Survey",
    description:
      "Sent after ticket resolution asking for a satisfaction rating.",
...
%{company.name}`,
  ...
  },
  {
    ...
    description:
      "Sent to customers during a major incident (proactive support).",
...
%{company.name}`,
  ...
  },
  {
    ...
    description:
      "Sent to the account manager when a contract is close to renewal.",
...
%{company.name}`,
  ...
  },
  {
    ...
    description:
      "Sent to agents when an in-app notification event occurs and email notifications are enabled.",
