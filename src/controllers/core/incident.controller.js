...
const incidentController = {
  ...
  linkCI: asyncHandler(async (req, res) => {
    const link = await IncidentService.linkCI(
      req.params.id,
      req.body.ciId,
      req.body.role,
      req.user.company,
  ...
  unlinkCI: asyncHandler(async (req, res) => {
    await IncidentService.unlinkCI(
      req.params.id,
      req.params.ciId,
      req.user.company,
    );
  ...
  linkServiceOffering: asyncHandler(async (req, res) => {
    const link = await IncidentService.linkServiceOffering(
      req.params.id,
  ...
  linkIncident: asyncHandler(async (req, res) => {
    const link = await IncidentService.linkIncident(
      req.params.id,
      req.body.targetIncidentId,
  ...
  listRelationships: asyncHandler(async (req, res) => {
    const relationships = await IncidentService.listRelationships(
      req.params.id,
      req.user.company,
    );
  ...
  reopen: asyncHandler(async (req, res) => {
    const incident = await IncidentService.reopen(
      req.params.id,
      req.user.company,
      req.user._id,
      req.body.reason,
  ...
  cancel: asyncHandler(async (req, res) => {
    const incident = await IncidentService.cancel(
      req.params.id,
      req.user.company,
      req.user._id,
      req.body.reason,
  ...
  listTasks: asyncHandler(async (req, res) => {
    const tasks = await IncidentService.listTasks(
      req.params.id,
      req.user.company,
      req.query,
    );
  ...
  getAssignmentHistory: asyncHandler(async (req, res) => {
    const history = await IncidentService.getAssignmentHistory(
      req.params.id,
      req.user.company,
    );
  ...
  getDuplicateCandidates: asyncHandler(async (req, res) => {
    const candidates = await IncidentService.getDuplicateCandidates(
      req.user.company,
      req.query.title,
      req.query.category,
    );
  ...
  nominateMajor: asyncHandler(async (req, res) => {
    const candidate = await MajorIncidentService.nominate(
      req.params.id,
      req.body,
      req.user.company,
      req.user._id,
  ...
  approveMajor: asyncHandler(async (req, res) => {
    const majorIncident = await MajorIncidentService.approve(
      req.params.id,
      req.user.company,
      req.user._id,
    );
  ...
  rejectMajor: asyncHandler(async (req, res) => {
    const candidate = await MajorIncidentService.reject(
      req.params.id,
      req.body.reason,
      req.user.company,
      req.user._id,
  ...
  demoteMajor: asyncHandler(async (req, res) => {
    const majorIncident = await MajorIncidentService.demote(
      req.params.id,
      req.body.reason,
      req.user.company,
      req.user._id,
  ...
  getMajorIncident: asyncHandler(async (req, res) => {
    const mi = await MajorIncidentService.getById(
      req.params.id,
      req.user.company,
    );
  ...
  listMajorCandidates: asyncHandler(async (req, res) => {
    const result = await MajorIncidentService.listCandidates(
      req.user.company,
      req.query,
    );
    res.json({ success: true, ...result });
  ...
  addMajorParticipant: asyncHandler(async (req, res) => {
    const participant = await MajorIncidentService.addParticipant(
      req.params.id,
      req.body,
      req.user.company,
      req.user._id,
  ...
  removeMajorParticipant: asyncHandler(async (req, res) => {
    await MajorIncidentService.removeParticipant(
      req.params.id,
      req.params.userId,
      req.user.company,
    );
  ...
  listMajorParticipants: asyncHandler(async (req, res) => {
    const participants = await MajorIncidentService.listParticipants(
      req.params.id,
      req.user.company,
    );
  ...
  addMajorTimelineEvent: asyncHandler(async (req, res) => {
    const event = await MajorIncidentService.addTimelineEvent(
      req.params.id,
      req.body,
      req.user.company,
      req.user._id,
  ...
  listMajorTimelineEvents: asyncHandler(async (req, res) => {
    const events = await MajorIncidentService.listTimelineEvents(
      req.params.id,
      req.user.company,
      req.query,
    );
  ...
  updateMajorCommPlan: asyncHandler(async (req, res) => {
    const mi = await MajorIncidentService.updateCommunicationPlan(
      req.params.id,
      req.body,
      req.user.company,
      req.user._id,
  ...
  updateMajorExecSummary: asyncHandler(async (req, res) => {
    const mi = await MajorIncidentService.updateExecSummary(
      req.params.id,
      req.body.execSummary,
      req.user.company,
      req.user._id,
    );
    res.json({ success: true, data: mi });
  ...
  createPIR: asyncHandler(async (req, res) => {
    const pir = await PostIncidentReviewService.create(
      req.body,
      req.user.company,
      req.user._id,
    );
  ...
  listPIRs: asyncHandler(async (req, res) => {
    const result = await PostIncidentReviewService.list(
      req.user.company,
      req.query,
    );
    res.json({ success: true, ...result });
  ...
  getPIR: asyncHandler(async (req, res) => {
    const pir = await PostIncidentReviewService.getById(
      req.params.id,
      req.user.company,
    );
  ...
  updatePIR: asyncHandler(async (req, res) => {
    const pir = await PostIncidentReviewService.update(
      req.params.id,
      req.body,
      req.user.company,
      req.user._id,
  ...
  submitPIRForReview: asyncHandler(async (req, res) => {
    const pir = await PostIncidentReviewService.submitForReview(
      req.params.id,
      req.user.company,
      req.user._id,
    );
  ...
  approvePIR: asyncHandler(async (req, res) => {
    const pir = await PostIncidentReviewService.approve(
      req.params.id,
      req.user.company,
      req.user._id,
    );
  ...
  publishPIR: asyncHandler(async (req, res) => {
    const pir = await PostIncidentReviewService.publish(
      req.params.id,
      req.user.company,
      req.user._id,
    );
  ...
  addPIRActionItem: asyncHandler(async (req, res) => {
    const pir = await PostIncidentReviewService.addActionItem(
      req.params.id,
      req.body,
      req.user.company,
      req.user._id,
  ...
  updatePIRActionItem: asyncHandler(async (req, res) => {
    const pir = await PostIncidentReviewService.updateActionItem(
      req.params.id,
  ...
  deletePIRActionItem: asyncHandler(async (req, res) => {
    await PostIncidentReviewService.deleteActionItem(
      req.params.id,
      req.params.actionItemId,
      req.user.company,
    );
