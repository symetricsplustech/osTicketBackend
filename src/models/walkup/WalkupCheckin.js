...
const WalkupCheckinSchema = new Schema({
  ...
  checkinMethod: { type: String, enum: ['kiosk', 'mobile', 'desk', 'qr', 'appointment'], required: true },
  status: { type: String, enum: ['waiting', 'called', 'in_service', 'completed', 'no_show', 'cancelled'], default: 'waiting', index: true },
...
WalkupCheckinSchema.index({ tenantId: 1, locationId: 1, status: 1, checkinAt: -1 });
