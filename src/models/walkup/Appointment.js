...
const AppointmentSchema = new Schema({
  ...
  status: { type: String, enum: ['scheduled', 'confirmed', 'checked_in', 'in_service', 'completed', 'no_show', 'cancelled', 'rescheduled'], default: 'scheduled', index: true },
  ...
  outcome: { type: String, enum: ['resolved', 'escalated', 'deferred', 'no_show', 'cancelled'], default: 'resolved' },
