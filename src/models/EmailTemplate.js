...
const TRIGGERS = [
  {
    value: "new_ticket_confirmation",
    label: "New ticket created — customer confirmation",
    recipient: "user",
  },
  {
    value: "new_ticket_alert",
    label: "New ticket created — staff alert",
    recipient: "staff",
  },
  {
    value: "new_reply_alert",
    label: "Customer replied — staff alert",
    recipient: "staff",
  },
  {
    value: "ticket_response",
    label: "Staff responded to ticket",
    recipient: "user",
  },
  {
  ...
  },
  {
    ...
    label: "Ticket resolved — awaiting customer confirmation",
    recipient: "user",
  },
  {
    value: "sla_response_breach",
  ...
  {
    value: "admin_welcome",
    label: "Company admin account created",
    recipient: "admin",
  },
  {
    value: "company_admin_created",
    label: "Company registered on platform",
    recipient: "admin",
  },
];
