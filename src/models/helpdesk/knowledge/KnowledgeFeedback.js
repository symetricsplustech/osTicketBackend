...
const KnowledgeFeedbackSchema = new Schema(
  {
    ...
    source: {
      type: String,
      enum: ["article_view", "ticket_deflection", "search", "other"],
    ...
    responseAction: {
      type: String,
      enum: ["acknowledged", "addressed", "article_updated", "no_action"],
    },
...
KnowledgeFeedbackSchema.index(
  { tenantId: 1, userId: 1, articleId: 1 },
