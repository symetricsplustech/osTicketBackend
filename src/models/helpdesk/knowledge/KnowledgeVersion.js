...
const KnowledgeVersionSchema = new Schema({
  ...
  visibility: { type: String, enum: ['public', 'customers', 'employees', 'agents', 'department', 'team'] },
  internalOnly: { type: Boolean, default: false },
  lifecycle: { type: String, enum: ['draft', 'review', 'approved', 'published', 'expired', 'archived'] },

  // Metadata
  changeSummary: { type: String, trim: true, default: '' },
  changeType: { type: String, enum: ['create', 'edit', 'publish', 'retire', 'restore'], default: 'edit' },
