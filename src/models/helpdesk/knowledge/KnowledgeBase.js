...
const KnowledgeBaseSchema = new Schema({
  ...
  // Visibility
  visibility: { type: String, enum: ['public', 'customers', 'employees', 'agents'], default: 'public', index: true },
...
KnowledgeBaseSchema.index({ tenantId: 1, name: 1 }, { unique: true, partialFilterExpression: { isDeleted: false } });
