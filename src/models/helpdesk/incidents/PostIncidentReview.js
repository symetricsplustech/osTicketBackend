...
const postIncidentReviewSchema = new mongoose.Schema(
  {
    ...
    majorIncident: { type: mongoose.Schema.Types.ObjectId, ref: 'MajorIncident', default: null, index: true },
    ...
    rootCauseAnalysis: {
      ...
      category: {
        type: String,
        enum: ['code_defect', 'configuration', 'infrastructure', 'third_party', 'process_gap', 'human_error', 'unknown'],
        default: 'unknown',
      },
