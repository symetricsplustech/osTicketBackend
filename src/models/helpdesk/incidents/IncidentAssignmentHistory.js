...
incidentAssignmentHistorySchema.index({ company: 1, incident: 1, assignedAt: -1 });

module.exports = mongoose.model('IncidentAssignmentHistory', incidentAssignmentHistorySchema);
