...
const CommunicationPlanSchema = new Schema({
  ...
  internal: { enabled: { type: Boolean, default: true }, cadenceMinutes: { type: Number, default: 30 }, channels: [{ type: String }] },
  external: { enabled: { type: Boolean, default: true }, cadenceMinutes: { type: Number, default: 60 }, channels: [{ type: String }] },
  stakeholder: { enabled: { type: Boolean, default: true }, cadenceMinutes: { type: Number, default: 60 } },
  executive: { enabled: { type: Boolean, default: true }, cadenceMinutes: { type: Number, default: 120 } },
