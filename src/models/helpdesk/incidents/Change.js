...
const changeSchema = new mongoose.Schema(
  {
    ...
    type: {
      type: String,
      enum: ["normal", "standard", "emergency", "registration"],
      default: "normal",
    },
    model: {
      type: mongoose.Schema.Types.ObjectId,
...
module.exports =
  mongoose.models.Change || mongoose.model("Change", changeSchema);
