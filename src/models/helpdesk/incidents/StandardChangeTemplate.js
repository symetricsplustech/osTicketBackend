...
const standardChangeTemplateSchema = new mongoose.Schema(
  {
    ...
    defaultAssignmentGroup: { type: mongoose.Schema.Types.ObjectId, ref: 'Group', default: null },
...
module.exports = mongoose.model('StandardChangeTemplate', standardChangeTemplateSchema);
