...
const incidentSchema = new mongoose.Schema(
  {
    ...
    status: {
      type: String,
      enum: ['new', 'in_progress', 'on_hold_caller', 'on_hold_change', 'on_hold_problem', 'on_hold_vendor', 'resolved', 'closed', 'canceled', 'investigating', 'identified', 'monitoring'],
      default: 'new',
    },
    priority: {
      type: String,
    ...
    parentIncident: { type: mongoose.Schema.Types.ObjectId, ref: 'Incident', default: null, index: true },
...
incidentSchema.statics.STATUSES = [
  'new', 'in_progress', 'on_hold_caller', 'on_hold_change', 'on_hold_problem',
  'on_hold_vendor', 'resolved', 'closed', 'canceled', 'investigating', 'identified', 'monitoring',
];
...
incidentSchema.statics.RESOLUTION_CODES = [
  'fixed', 'workaround', 'duplicate', 'not_reproducible', 'not_a_bug',
  'user_error', 'by_design', 'third_party', 'will_not_fix',
];
...
incidentSchema.statics.HOLD_REASONS = ['awaiting_caller', 'awaiting_change', 'awaiting_problem', 'awaiting_vendor'];
