...
const problemSchema = new mongoose.Schema(
  {
    ...
    status: {
      type: String,
      enum: ['new', 'assess', 'root_cause_analysis', 'fix_in_progress', 'resolved', 'closed', 'canceled', 'risk_accepted'],
      default: 'new',
    },
    priority: {
      type: String,
    ...
    knownErrorId: { type: mongoose.Schema.Types.ObjectId, ref: 'KnownError', default: null, index: true },
...
problemSchema.statics.STATUSES = [
  'new', 'assess', 'root_cause_analysis', 'fix_in_progress', 'resolved', 'closed', 'canceled', 'risk_accepted',
];

problemSchema.statics.PRIORITIES = ['Low', 'Normal', 'High', 'Emergency'];

problemSchema.statics.ROOT_CAUSE_CATEGORIES = [
  'code_defect', 'configuration', 'infrastructure', 'third_party', 'human_error', 'process_gap', 'unknown',
];
