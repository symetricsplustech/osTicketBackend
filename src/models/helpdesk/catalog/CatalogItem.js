...
const CatalogItemSchema = new Schema({
  ...
  categoryId: { type: Schema.Types.ObjectId, ref: 'CatalogCategory', index: true },
  ...
  fulfillmentTemplate: { type: Schema.Types.ObjectId, ref: 'FulfillmentPlan' },

  // Approval
  requiresApproval: { type: Boolean, default: false },
  approvalPolicy: { type: Schema.Types.ObjectId, ref: 'ChangeApprovalPolicy' },
  approvalMode: { type: String, enum: ['individual', 'group', 'sequential', 'parallel'], default: 'individual' },
...
CatalogItemSchema.index({ tenantId: 1, isActive: 1, visibleInPortal: 1, isDeleted: 1 });
CatalogItemSchema.index({ tenantId: 1, categoryId: 1, sortOrder: 1 });
CatalogItemSchema.index({ tenantId: 1, name: 'text', title: 'text', description: 'text' });
