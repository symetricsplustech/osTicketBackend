...
const CatalogTaskSchema = new Schema({
  ...
  status: { type: String, enum: ['open', 'work_in_progress', 'closed_complete', 'closed_incomplete', 'closed_skipped'], default: 'open', index: true },

  // Ordering
  order: { type: Number, required: true, index: true },
  parallelGroup: { type: String },
  executionType: { type: String, enum: ['sequential', 'parallel'], default: 'sequential' },
...
CatalogTaskSchema.index({ tenantId: 1, requestedItemId: 1, order: 1, isDeleted: 1 });
