...
const ShiftSchema = new Schema({
  ...
  onCallAgent: { type: Schema.Types.ObjectId, ref: 'User', required: true, index: true },
  secondaryAgent: { type: Schema.Types.ObjectId, ref: 'User' },
  status: { type: String, enum: ['scheduled', 'active', 'completed', 'cancelled', 'conflict'], default: 'scheduled', index: true },
