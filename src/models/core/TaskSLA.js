...
const taskSLASchema = new mongoose.Schema(
  {
    ...
    slaPlanId: { type: mongoose.Schema.Types.ObjectId, ref: 'SlaPlan', default: null },
    name: { type: String, required: true },
    type: { type: String, enum: ['response', 'resolution', 'breach'], default: 'response' },
    status: {
      type: String,
      enum: ['pending', 'active', 'paused', 'achieved', 'breached', 'cancelled'],
      default: 'pending',
      index: true,
    },
