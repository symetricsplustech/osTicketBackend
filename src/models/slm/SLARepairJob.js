...
const SLARepairJobSchema = new Schema({
  ...
  triggerType: { type: String, enum: ['sla_plan_change', 'schedule_change', 'holiday_change', 'manual', 'bulk_import'], required: true },
  ...
  errors: [{ ticketId: { type: Schema.Types.ObjectId }, error: { type: String }, timestamp: { type: Date } }],
