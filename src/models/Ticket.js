...
const ticketSchema = new mongoose.Schema(
  {
    ...
    urgency: { type: String, enum: ['low', 'medium', 'normal', 'high', 'critical'], default: null },
    ...
    resolvedBy: { type: mongoose.Schema.Types.ObjectId, ref: 'Agent', default: null },
    ...
    resolution: {
      ...
      kbArticle: { type: mongoose.Schema.Types.ObjectId, ref: 'Faq', default: null },
    },
    ...
    waitingOn: { type: String, enum: ['customer', 'agent', 'vendor', 'approval', 'none'], default: 'none' },
