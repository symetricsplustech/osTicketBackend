...
const ApprovalDecisionSchema = new Schema({
  ...
  stepId: { type: Schema.Types.ObjectId, ref: 'ApprovalStep', required: true },
  approverId: { type: Schema.Types.ObjectId, ref: 'User', required: true, index: true },
  approverName: { type: String, default: '' },
  decision: { type: String, enum: ['approved', 'rejected', 'skipped', 'delegated', 'expired'], required: true, index: true },
  ...
  autoReason: { type: String, enum: ['timeout', 'escalation', 'policy', 'delegation_chain', null] },
