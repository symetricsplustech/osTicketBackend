...
const AgentPresenceSchema = new Schema({
  ...
  status: { type: String, enum: ['available', 'busy', 'away', 'offline', 'on_break', 'in_meeting', 'dnd'], required: true, index: true },
  ...
  source: { type: String, enum: ['system', 'manual', 'schedule', 'heartbeat'], default: 'manual' },
