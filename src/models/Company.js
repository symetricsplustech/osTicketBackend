...
const companySchema = new mongoose.Schema(
  {
    ...
    status: {
      type: String,
      enum: ['pending_verification', 'trial', 'active', 'grace', 'restricted', 'suspended', 'expired', 'archived', 'terminated'],
      default: 'trial',
      index: true,
    },
    // Company owner (tenant owner agent) + self-registration verification.
    ownerId: { type: mongoose.Schema.Types.ObjectId, ref: 'Agent', default: null },
    ...
    lifecycleHistory: [{ status: String, reason: String, actor: { type: mongoose.Schema.Types.ObjectId, ref: 'SuperAdmin' }, at: { type: Date, default: Date.now } }],
