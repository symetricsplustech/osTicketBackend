...
router.get(
  "/known-errors",
  requirePermission("itsm.problem.problem.read"),
  ctrl.listKnownErrors,
);
...
router.put(
  "/:id",
  requirePermission("itsm.problem.problem.update"),
  ctrl.update,
);
router.post(
  "/:id/transition",
...
router.post(
  "/:id/assign",
  requirePermission("itsm.problem.assign"),
  ctrl.assign,
);
router.post(
  "/:id/comment",
...
router.post(
  "/:id/known-error",
  requirePermission("itsm.problem.problem.update"),
  ctrl.createKnownError,
);
router.post(
  "/:id/root-cause",
  requirePermission("itsm.problem.problem.update"),
  ctrl.createRootCauseRecord,
);
router.get(
  "/:id/root-cause",
  requirePermission("itsm.problem.problem.read"),
  ctrl.listRootCauseRecords,
);
