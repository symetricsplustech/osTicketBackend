...
router.get(
  ...
  protectTenantPrincipal,
  ctrl.listRosterMembers,
);
router.post(
  "/rosters/:rosterId/members",
  protectTenantPrincipal,
  ctrl.addRosterMember,
);
router.delete(
  "/rosters/:rosterId/members/:userId",
  protectTenantPrincipal,
  ctrl.removeRosterMember,
);
...
router.post(
  "/rotations/:id/advance",
  protectTenantPrincipal,
  ctrl.advanceRotation,
);
...
router.post(
  "/coverage/:id/approve",
  protectTenantPrincipal,
  ctrl.approveCoverageRequest,
);
router.post(
  "/coverage/:id/reject",
  protectTenantPrincipal,
  ctrl.rejectCoverageRequest,
);
...
router.post(
  "/timeoff/:id/approve",
  protectTenantPrincipal,
  ctrl.approveTimeOffRequest,
);
router.post(
  "/timeoff/:id/reject",
  protectTenantPrincipal,
  ctrl.rejectTimeOffRequest,
);
...
router.get(
  "/escalation-policies",
  protectTenantPrincipal,
  ctrl.listEscalationPolicies,
);
router.get(
  "/escalation-policies/:id",
  protectTenantPrincipal,
  ctrl.getEscalationPolicy,
);
router.post(
  "/escalation-policies",
  protectTenantPrincipal,
...
router.put(
  "/escalation-policies/:id",
  protectTenantPrincipal,
  ctrl.updateEscalationPolicy,
);
router.delete(
  "/escalation-policies/:id",
  protectTenantPrincipal,
  ctrl.deleteEscalationPolicy,
);
...
router.get(
  ...
  protectTenantPrincipal,
  ctrl.listEscalationLevels,
);
router.post(
  "/escalation-policies/:policyId/levels",
  protectTenantPrincipal,
  ctrl.createEscalationLevel,
);
router.put(
  "/escalation-levels/:id",
  protectTenantPrincipal,
  ctrl.updateEscalationLevel,
);
router.delete(
  "/escalation-levels/:id",
  protectTenantPrincipal,
  ctrl.deleteEscalationLevel,
);

// ─── Contact Preferences ────────────────────────────────────────────────
router.get(
  "/contact-preferences/:userId",
  protectTenantPrincipal,
  ctrl.getContactPreference,
);
router.put(
  "/contact-preferences/:userId",
  protectTenantPrincipal,
  ctrl.updateContactPreference,
);
...
router.get(
  "/current/:scheduleId",
  protectTenantPrincipal,
  ctrl.getCurrentOnCall,
);
router.get(
  "/upcoming/:scheduleId",
  protectTenantPrincipal,
  ctrl.getUpcomingShifts,
);
router.get(
  "/agent/team/:teamId",
  protectTenantPrincipal,
  ctrl.getOnCallAgentForTeam,
);
