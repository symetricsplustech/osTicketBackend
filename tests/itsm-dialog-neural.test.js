...
const { tokenize, cosineScore, termFreq } = require('../src/services/suggestion.service');
...
const docFreq = new Map([
  ['laptop', 2], ['slow', 2], ['broken', 1], ['performance', 1], ['issue', 1],
  ['resolved', 1], ['my', 1], ['and', 1], ['is', 1],
]);
const score = cosineScore(q, d, docFreq, 3);
assert(Number.isFinite(score) && score > 0 && score <= 1, `cosineScore bounded (0 < ${score.toFixed(3)} <= 1)`);
